...
const SIDEBAR_WIDTH_MOBILE = "min(20rem, 100dvw)"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) max-w-none bg-sidebar p-0 text-sidebar-foreground [&>button]:right-3 [&>button]:top-3 [&>button]:text-sidebar-foreground/70 [&>button]:hover:bg-sidebar-accent [&>button]:hover:text-sidebar-foreground"
          style={
            {
    ...
    return (
      <>
        <div
          ...
          className="hidden w-(--sidebar-width) shrink-0 lg:block"
        />
        <div
          data-slot="sidebar"
          className={cn(
            "fixed inset-y-0 left-0 z-30 hidden h-svh w-(--sidebar-width) flex-col border-r bg-sidebar text-sidebar-foreground lg:flex",
            className
          )}
          {...props}>
          {children}
