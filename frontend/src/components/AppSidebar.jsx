import { BarChart3, Boxes, Camera, CreditCard, LayoutDashboard, Package, QrCode, ShieldCheck, Users, WalletCards } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { id: "qrAccess", icon: QrCode, label: "Acceso QR", roles: ["SUDO", "ACCESS"] },
