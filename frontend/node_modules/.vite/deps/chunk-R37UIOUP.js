...
function useFloating2(options = {}) {
  ...
  const [localDomReference, setLocalDomReference] = React21.useState(void 0);
  const [localFloatingElement, setLocalFloatingElement] = React21.useState(void 0);
  const domReferenceRef = React21.useRef(null);
  const tree = useFloatingTree(externalTree);
  const storeElements = React21.useMemo(() => ({
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-R37UIOUP.js.map
