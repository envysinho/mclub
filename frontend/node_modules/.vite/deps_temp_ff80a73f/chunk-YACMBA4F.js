...
function useDialogRoot(params) {
  ...
  const handleImperativeClose = React9.useCallback(() => {
    store.setOpen(false, createChangeEventDetails(reason_parts_exports.imperativeAction));
  }, [store]);
  React9.useImperativeHandle(actionsRef, () => ({
...
function DialogInteractions({
  ...
  const floatingRootContext = store.useState("floatingRootContext");
  const [ownNestedOpenDialogs, setOwnNestedOpenDialogs] = React9.useState(0);
  const [ownNestedOpenDrawers, setOwnNestedOpenDrawers] = React9.useState(0);
...
var DialogStore = class _DialogStore extends ReactStore {
  constructor(initialState, floatingId, nested = false) {
    ...
    super(state, {
      popupRef: React10.createRef(),
      backdropRef: React10.createRef(),
      internalBackdropRef: React10.createRef(),
...
function useRenderDialogRoot(props, mode = "dialog") {
  ...
  return (0, import_jsx_runtime4.jsx)(IsDrawerContext.Provider, {
    value: false,
    children: (0, import_jsx_runtime4.jsxs)(DialogRootContext.Provider, {
      value: contextValue,
      children: [shouldRenderInteractions && (0, import_jsx_runtime4.jsx)(DialogInteractions, {
        store,
...
function DialogRoot(props) {
  const mode = React12.useContext(IsDrawerContext) ? "drawer" : "dialog";
...
var DialogTitle = React14.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React17.useState(null);
...
// node_modules/@base-ui/react/dialog/trigger/DialogTrigger.mjs
var DialogTrigger = React18.forwardRef(function DialogTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const triggerElementRef = React18.useRef(null);
  const {
    registerTrigger,
...
//# sourceMappingURL=chunk-YACMBA4F.js.map
