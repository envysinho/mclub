...
function useAriaLabelledBy(explicitAriaLabelledBy, labelId, labelSourceRef, enableFallback = true, labelSourceId) {
  const [fallbackAriaLabelledBy, setFallbackAriaLabelledBy] = React6.useState();
...
function useFieldValidation(params) {
  ...
  const registerInput = React8.useCallback((element) => {
    if (!element) {
      return void 0;
    }
...
// node_modules/@base-ui/react/field/control/FieldControl.mjs
var FieldControl = React17.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React18.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React18.useMemo(() => {
    return {
...
//# sourceMappingURL=chunk-RGKI44EF.js.map
