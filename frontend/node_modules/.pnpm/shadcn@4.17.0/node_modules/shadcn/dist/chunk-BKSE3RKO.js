...
`;}}this.out.write(this.outputText);}}return as=a,as}var cs,oo;function Nf(){if(oo)return cs;oo=1;let e=te(),t=Ie(),{style:r,clear:s}=oe(),{cursor:n,erase:i}=re();class o extends t{constructor(a={}){super(a),this.msg=a.message,this.value=!!a.initial,this.active=a.active||"on",this.inactive=a.inactive||"off",this.initialValue=this.value,this.render();}reset(){this.value=this.initialValue,this.fire(),this.render();}exit(){this.abort();}abort(){this.done=this.aborted=true,this.fire(),this.render(),this.out.write(`
`),this.close();}submit(){this.done=true,this.aborted=false,this.fire(),this.render(),this.out.write(`
`),this.close();}deactivate(){if(this.value===false)return this.bell();this.value=false,this.render();}activate(){if(this.value===true)return this.bell();this.value=true,this.render();}delete(){this.deactivate();}left(){this.deactivate();}right(){this.activate();}down(){this.deactivate();}up(){this.activate();}next(){this.value=!this.value,this.fire(),this.render();}_(a,f){if(a===" ")this.value=!this.value;else if(a==="1")this.value=true;else if(a==="0")this.value=false;else return this.bell();this.render();}render(){this.closed||(this.firstRender?this.out.write(n.hide):this.out.write(s(this.outputText,this.out.columns)),super.render(),this.outputText=[r.symbol(this.done,this.aborted),e.bold(this.msg),r.delimiter(this.done),this.value?this.inactive:e.cyan().underline(this.inactive),e.gray("/"),this.value?e.cyan().underline(this.active):this.active].join(" "),this.out.write(i.line+n.to(0)+this.outputText));}}return cs=o,cs}var ls,ao;function pe(){if(ao)return ls;ao=1;class e{constructor({token:r,date:s,parts:n,locales:i}){this.token=r,this.date=s||new Date,this.parts=n||[this],this.locales=i||{};}up(){}down(){}next(){let r=this.parts.indexOf(this);return this.parts.find((s,n)=>n>r&&s instanceof e)}setTo(r){}prev(){let r=[].concat(this.parts).reverse(),s=r.indexOf(this);return r.find((n,i)=>i>s&&n instanceof e)}toString(){return String(this.date)}}return ls=e,ls}var us,co;function _f(){if(co)return us;co=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setHours((this.date.getHours()+12)%24);}down(){this.up();}toString(){let s=this.date.getHours()>12?"pm":"am";return /\A/.test(this.token)?s.toUpperCase():s}}return us=t,us}var fs,lo;function Ff(){if(lo)return fs;lo=1;let e=pe(),t=s=>(s=s%10,s===1?"st":s===2?"nd":s===3?"rd":"th");class r extends e{constructor(n={}){super(n);}up(){this.date.setDate(this.date.getDate()+1);}down(){this.date.setDate(this.date.getDate()-1);}setTo(n){this.date.setDate(parseInt(n.substr(-2)));}toString(){let n=this.date.getDate(),i=this.date.getDay();return this.token==="DD"?String(n).padStart(2,"0"):this.token==="Do"?n+t(n):this.token==="d"?i+1:this.token==="ddd"?this.locales.weekdaysShort[i]:this.token==="dddd"?this.locales.weekdays[i]:n}}return fs=r,fs}var ps,uo;function Mf(){if(uo)return ps;uo=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setHours(this.date.getHours()+1);}down(){this.date.setHours(this.date.getHours()-1);}setTo(s){this.date.setHours(parseInt(s.substr(-2)));}toString(){let s=this.date.getHours();return /h/.test(this.token)&&(s=s%12||12),this.token.length>1?String(s).padStart(2,"0"):s}}return ps=t,ps}var ds,fo;function Df(){if(fo)return ds;fo=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setMilliseconds(this.date.getMilliseconds()+1);}down(){this.date.setMilliseconds(this.date.getMilliseconds()-1);}setTo(s){this.date.setMilliseconds(parseInt(s.substr(-this.token.length)));}toString(){return String(this.date.getMilliseconds()).padStart(4,"0").substr(0,this.token.length)}}return ds=t,ds}var hs,po;function Lf(){if(po)return hs;po=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setMinutes(this.date.getMinutes()+1);}down(){this.date.setMinutes(this.date.getMinutes()-1);}setTo(s){this.date.setMinutes(parseInt(s.substr(-2)));}toString(){let s=this.date.getMinutes();return this.token.length>1?String(s).padStart(2,"0"):s}}return hs=t,hs}var ms,ho;function Vf(){if(ho)return ms;ho=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setMonth(this.date.getMonth()+1);}down(){this.date.setMonth(this.date.getMonth()-1);}setTo(s){s=parseInt(s.substr(-2))-1,this.date.setMonth(s<0?0:s);}toString(){let s=this.date.getMonth(),n=this.token.length;return n===2?String(s+1).padStart(2,"0"):n===3?this.locales.monthsShort[s]:n===4?this.locales.months[s]:String(s+1)}}return ms=t,ms}var gs,mo;function Wf(){if(mo)return gs;mo=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setSeconds(this.date.getSeconds()+1);}down(){this.date.setSeconds(this.date.getSeconds()-1);}setTo(s){this.date.setSeconds(parseInt(s.substr(-2)));}toString(){let s=this.date.getSeconds();return this.token.length>1?String(s).padStart(2,"0"):s}}return gs=t,gs}var ys,go;function zf(){if(go)return ys;go=1;let e=pe();class t extends e{constructor(s={}){super(s);}up(){this.date.setFullYear(this.date.getFullYear()+1);}down(){this.date.setFullYear(this.date.getFullYear()-1);}setTo(s){this.date.setFullYear(s.substr(-4));}toString(){let s=String(this.date.getFullYear()).padStart(4,"0");return this.token.length===2?s.substr(-2):s}}return ys=t,ys}var ws,yo;function Uf(){return yo||(yo=1,ws={DatePart:pe(),Meridiem:_f(),Day:Ff(),Hours:Mf(),Milliseconds:Df(),Minutes:Lf(),Month:Vf(),Seconds:Wf(),Year:zf()}),ws}var xs,wo;function Hf(){if(wo)return xs;wo=1;let e=te(),t=Ie(),{style:r,clear:s,figures:n}=oe(),{erase:i,cursor:o}=re(),{DatePart:c,Meridiem:a,Day:f,Hours:l,Milliseconds:u,Minutes:d,Month:p,Seconds:h,Year:m}=Uf(),g=/\\(.)|"((?:\\["\\]|[^"])+)"|(D[Do]?|d{3,4}|d)|(M{1,4})|(YY(?:YY)?)|([aA])|([Hh]{1,2})|(m{1,2})|(s{1,2})|(S{1,4})|./g,x={1:({token:v})=>v.replace(/\\(.)/g,"$1"),2:v=>new f(v),3:v=>new p(v),4:v=>new m(v),5:v=>new a(v),6:v=>new l(v),7:v=>new d(v),8:v=>new h(v),9:v=>new u(v)},y={months:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),monthsShort:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),weekdays:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),weekdaysShort:"Sun,Mon,Tue,Wed,Thu,Fri,Sat".split(",")};class w extends t{constructor(b={}){super(b),this.msg=b.message,this.cursor=0,this.typed="",this.locales=Object.assign(y,b.locales),this._date=b.initial||new Date,this.errorMsg=b.error||"Please Enter A Valid Value",this.validator=b.validate||(()=>true),this.mask=b.mask||"YYYY-MM-DD HH:mm:ss",this.clear=s("",this.out.columns),this.render();}get value(){return this.date}get date(){return this._date}set date(b){b&&this._date.setTime(b.getTime());}set mask(b){let R;for(this.parts=[];R=g.exec(b);){let k=R.shift(),P=R.findIndex(D=>D!=null);this.parts.push(P in x?x[P]({token:R[P]||k,date:this.date,parts:this.parts,locales:this.locales}):R[P]||k);}let E=this.parts.reduce((k,P)=>(typeof P=="string"&&typeof k[k.length-1]=="string"?k[k.length-1]+=P:k.push(P),k),[]);this.parts.splice(0),this.parts.push(...E),this.reset();}moveCursor(b){this.typed="",this.cursor=b,this.fire();}reset(){this.moveCursor(this.parts.findIndex(b=>b instanceof c)),this.fire(),this.render();}exit(){this.abort();}abort(){this.done=this.aborted=true,this.error=false,this.fire(),this.render(),this.out.write(`
...
`}}),e.append(n),e.insertBefore(n,A$1.comment({text:"---break---"}))),typeof s=="object")for(let[i,o]of Object.entries(s))if(i.startsWith("@")){let c=i.match(/@([a-zA-Z-]+)\s*(.*)/);if(c){let[,a,f]=c;ia(n,a,f,o);}}else Le(n,i,o);else if(typeof s=="string")try{let o=A$1.parse(`.temp{${s}}`).first;if(o&&o.nodes){let c=A$1.rule({selector:"temp",raws:{semicolon:!0,between:" ",before:`
  ...
  `}}),e.append(s)),typeof r=="object"){for(let[n,i]of Object.entries(r))if(n.startsWith("@")&&typeof i=="object"&&i!==null&&Object.keys(i).length===0){let o=n.match(/@([a-zA-Z-]+)\s*(.*)/);if(o){let[,c,a]=o;if(!s.nodes?.find(l=>l.type==="atrule"&&l.name===c&&l.params===a)){if(c==="apply"){let u=s.nodes?.find(d=>d.type==="atrule"&&d.name==="apply");if(u){u.params=twMerge(u.params,a);continue}}let l=A$1.atRule({name:c,params:a,raws:{semicolon:true,before:`
    ...
    `,s?.append(c);}});}catch(n){throw console.error("Error parsing rule content:",t,r,n),n}}async function Bs(e,t,r,s){let n=J(r.resolvedPaths.cwd,false),i=await Bp(r),o=i!=="expo";if(e=oa(e,n,{skipInstalled:o}),t=oa(t,n,{skipInstalled:o}),!e?.length&&!t?.length)return;s={silent:false,interactive:true,...s};let c=j("Installing dependencies.",{silent:s.silent})?.start(),a="";if(Gp(r)&&i==="npm")if(s.silent||!s.interactive)a="force";else {c.stopAndPersist(),I.warn(`
It looks like you are using React 19. 
Some packages may fail to install due to peer dependency issues in npm (see ${V}/react-19).
`);let f=await Wc([{type:"select",name:"flag",message:"How would you like to proceed?",choices:[{title:"Use --force",value:"force"},{title:"Use --legacy-peer-deps",value:"legacy-peer-deps"}]}]);f&&(a=f.flag);}c?.start(),await qp(i,e,t,r.resolvedPaths.cwd,a),c?.succeed();}function oa(e=[],t,{skipInstalled:r=true}={}){let s=new Set([...Object.keys(t?.dependencies??{}),...Object.keys(t?.devDependencies??{}),...Object.keys(t?.optionalDependencies??{}),...Object.keys(t?.peerDependencies??{})]),n=new Map;for(let i of e){let o=Kp(i);if(!o){n.set(i,{dependency:i,hasSpecifier:true});continue}if(r&&!o.hasSpecifier&&s.has(o.name))continue;let c=n.get(o.name);(!c||!c.hasSpecifier&&o.hasSpecifier)&&n.set(o.name,{dependency:i,hasSpecifier:o.hasSpecifier});}return Array.from(n.values()).map(({dependency:i})=>i)}function Kp(e){if(/^[a-z][a-z0-9+.-]*:/i.test(e))return null;let t=e.startsWith("@")?e.match(/^(@[^/]+\/[^@/]+)(@.+)?$/):e.match(/^([^@/]+)(@.+)?$/);return t?{name:t[1],hasSpecifier:!!t[2]}:null}function Gp(e){let t=J(e.resolvedPaths.cwd,false);if(!t?.dependencies?.react)return  false;let r=/^(?:\^|~)?19(?:\.\d+)*(?:-.*)?$/.test(t.dependencies.react),s=t.dependencies["react-day-picker"]?.startsWith("8");return r&&s}async function Bp(e){return J(e.resolvedPaths.cwd,false)?.dependencies?.expo?"expo":Ds(e.resolvedPaths.cwd)}function Qe(e){for(let t of e)if(t.trim().startsWith("-"))throw new Error(`Invalid dependency "${t}": dependency names cannot start with "-".`)}async function qp(e,t,r,s,n){if(e==="npm")return Jp(t,r,s,n);if(e==="deno")return Yp(t,r,s);if(e==="expo")return Zp(t,r,s);Qe(t),Qe(r),t?.length&&await execa(e,["add","--",...t],{cwd:s}),r?.length&&await execa(e,["add","-D","--",...r],{cwd:s});}async function Jp(e,t,r,s){Qe(e),Qe(t),e.length&&await execa("npm",["install",...s?[`--${s}`]:[],"--",...e],{cwd:r}),t.length&&await execa("npm",["install",...s?[`--${s}`]:[],"-D","--",...t],{cwd:r});}async function Yp(e,t,r){e?.length&&await execa("deno",["add",...e.map(s=>`npm:${s}`)],{cwd:r}),t?.length&&await execa("deno",["add","-D",...t.map(s=>`npm:${s}`)],{cwd:r});}async function Zp(e,t,r){Qe(e),Qe(t),e.length&&await execa("npx",["expo","install","--",...e],{cwd:r}),t.length&&await execa("npx",["expo","install","-- -D","--",...t],{cwd:r});}async function Js(e,t,r){if(!e||Object.keys(e).length===0)return {envVarsAdded:[],envFileUpdated:null,envFileCreated:null};r={silent:false,...r};let s=j("Adding environment variables.",{silent:r.silent})?.start(),n=t.resolvedPaths.cwd,i=S__default.join(n,".env.local"),o=Ut(n);o&&(i=o);let c=existsSync(i),a=S__default.basename(i),f=Object.entries(e).map(([p,h])=>`${p}=${h}`).join(`
...
`,"utf-8"),d=S__default.relative(n,i),l=Object.keys(e),s?.succeed(`Added the following variables to ${T.info(a)}:`),!r.silent)for(let p of l)I.log(`  ${T.success("+")} ${p}`);return !r.silent&&l.length>0&&I.break(),{envVarsAdded:l,envFileUpdated:u,envFileCreated:d}}var nd=new Set(["--font-sans","--font-serif","--font-mono"]);async function Ys(e,t){if(!e.fonts?.length)return e;let r=await Y(t.resolvedPaths.cwd);if(!r)return e;e.cssVars??={},e.cssVars.theme??={};let s=r.framework.name==="next-app"||r.framework.name==="next-pages";for(let n of e.fonts)if(s)e.cssVars.theme[n.font.variable]=`var(${n.font.variable})`;else {let i=n.name.replace("font-",""),o=n.font.dependency??`@fontsource-variable/${i}`;e.dependencies??=[],e.dependencies.push(o),e.css??={},e.css[`@import "${o}"`]={},e.cssVars.theme[n.font.variable]=n.font.family;}if(e.fonts.length>0){let n=new Map;for(let i of e.fonts){let o=i.font.selector??ld(i.font.variable);if(!o)continue;let c=i.font.variable.replace("--","");n.has(o)||n.set(o,[]),n.get(o).push(c);}e.css??={},e.css["@layer base"]??={};for(let[i,o]of Array.from(n.entries())){let c=o.join(" ");e.css["@layer base"][i]??={};let a=Object.keys(e.css["@layer base"][i]).find(f=>f.startsWith("@apply "));a?(delete e.css["@layer base"][i][a],e.css["@layer base"][i][`${a} ${c}`]={}):e.css["@layer base"][i][`@apply ${c}`]={};}}return e}async function Zs(e,t,r){if(!e?.length)return;let s=await Y(t.resolvedPaths.cwd);if(!s||s.framework.name!=="next-app"&&s.framework.name!=="next-pages")return;let n=j("Updating fonts.",{silent:r.silent})?.start();try{await id(e,t,s),n?.succeed("Updating fonts.");}catch(i){throw n?.fail("Failed to update fonts."),i}}async function id(e,t,r){let s=await od(t,r);if(!s)return;let n=await promises.readFile(s,"utf-8"),i=await ad(n,e,t);i!==n&&await promises.writeFile(s,i,"utf-8");}async function od(e,t){let r=e.resolvedPaths.cwd,s=t.isSrcDir,i=t.isTsx?"tsx":"jsx",o=s?[`src/app/layout.${i}`,`app/layout.${i}`]:[`app/layout.${i}`];for(let c of o){let a=S__default.join(r,c);if(existsSync(a))return a}return null}async function ad(e,t,r){let n=new Project({compilerOptions:{}}).createSourceFile("layout.tsx",e,{scriptKind:ScriptKind.TSX}),i=t.filter(u=>u.font.provider==="google"),o=[],c=[];for(let u of i){let d=u.font.import;if(!d)continue;let p=n.getImportDeclaration(w=>w.getModuleSpecifierValue()==="next/font/google"),h=false;p?(h=p.getNamedImports().some(v=>v.getName()===d),h||p.addNamedImport(d)):n.addImportDeclaration({moduleSpecifier:"next/font/google",namedImports:[d]});let m=fd(d,u.font.variable),g=cd(u),x=hd(n,u.font.variable),y=m;if(!(h&&!x&&dr(u.font.variable)&&!md(n,d))){if(x)x.setInitializer(`${d}(${g})`),x.getName()!==m&&x.rename(m),y=m;else {let w=gd(n);n.insertVariableStatement(w,{declarationKind:VariableDeclarationKind.Const,declarations:[{name:m,initializer:`${d}(${g})`}]}).appendWhitespace(`
`);}o.push(y),ud(u)&&c.push(u.font.variable.replace("--",""));}}let a=new Set(["font-sans","font-serif","font-mono"]),f=[...c].reverse().find(u=>a.has(u)),l=c.filter(u=>!a.has(u));return f&&l.unshift(f),o.length>0&&yd(n,o,l,r),n.getFullText()}function cd(e){let t={};return e.font.subsets?.length&&(t.subsets=e.font.subsets),e.font.weight?.length&&(t.weight=e.font.weight),t.variable=e.font.variable,JSON.stringify(t).replace(/"([^"]+)":/g,"$1:").replace(/"/g,"'")}function dr(e){return nd.has(e)}function ld(e){return dr(e)?"html":null}function ud(e){return !e.font.selector&&dr(e.font.variable)}function fd(e,t){let r=pd(e);return dr(t)?r:`${r}${dd(t.replace(/^--font-/,""))}`}function pd(e){return e.split("_").map((t,r)=>r===0?t.toLowerCase():t.charAt(0).toUpperCase()+t.slice(1).toLowerCase()).join("")}function dd(e){return e.split("-").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join("")}function hd(e,t){let r=e.getVariableStatements();for(let s of r)for(let n of s.getDeclarations()){let i=n.getInitializer();if(!i||i.getKind()!==SyntaxKind.CallExpression)continue;let c=i.getArguments();if(c.length===0)continue;let a=c[0].getText();if(a.includes("variable:")&&a.includes(t))return n}return null}function md(e,t){let r=e.getVariableStatements();for(let s of r)for(let n of s.getDeclarations()){let i=n.getInitializer();if(!i||i.getKind()!==SyntaxKind.CallExpression)continue;let o=i;if(o.getExpression().getText()!==t)continue;let c=o.getArguments();if(!c.length)continue;let a=c[0].getText();if(a.includes("variable:")&&a.includes("--font-heading"))return  true}return  false}function gd(e){let t=e.getImportDeclarations();return t.length>0?t[t.length-1].getChildIndex()+1:0}function yd(e,t,r,s){let n=e.getDescendantsOfKind(SyntaxKind.JsxOpeningElement);for(let i of n){if(i.getTagNameNode().getText()!=="html")continue;let c=r.map(p=>`"${p}"`),a=t.map(p=>`${p}.variable`),f=[...c,...a],l=i.getAttribute("className");if(!l){bt(e,s),i.addAttribute({name:"className",initializer:`{cn(${f.join(", ")})}`});return}if(l.getKind()!==SyntaxKind.JsxAttribute)return;let u=l.asKindOrThrow(SyntaxKind.JsxAttribute),d=u.getInitializer();if(!d)return;if(d.getKind()===SyntaxKind.StringLiteral){let p=d.getText().slice(1,-1);bt(e,s),u.setInitializer(`{cn("${p}", ${f.join(", ")})}`);}else if(d.getKind()===SyntaxKind.JsxExpression){let p=d.asKindOrThrow(SyntaxKind.JsxExpression),h=p.getExpression();if(!h)return;let m=h.getText();if(m.startsWith("cn(")){let g=a.every(b=>m.includes(b)),x=r.every(b=>m.includes(`"${b}"`)),y=["font-sans","font-serif","font-mono"].filter(b=>!r.includes(b)).some(b=>m.includes(`"${b}"`));if(g&&x&&!y)continue;let w=xd(m,a);w=vd(w);let v=bd(w,f);p.replaceWithText(`{${v}}`);}else if(/^\w+\.variable$/.test(m)){if(a.includes(m)&&r.length===0)continue;bt(e,s);let x=(m.split(".")[0]??"").toLowerCase().includes("heading")||r.length===0;p.replaceWithText(x?`{cn(${m}, ${f.join(", ")})}`:`{cn(${f.join(", ")})}`);}else if(m.startsWith("`")&&m.endsWith("`")){let g=wd(m);bt(e,s);let x=new Set(f),y=new Set(["font-sans","font-serif","font-mono"].map(v=>`"${v}"`)),w=g.filter(v=>!x.has(v)&&!y.has(v));p.replaceWithText(`{cn(${[...w,...f].join(", ")})}`);}else bt(e,s),p.replaceWithText(`{cn(${m}, ${f.join(", ")})}`);}}}function bt(e,t){if(!e.getImportDeclaration(s=>s.getNamedImports().some(i=>i.getName()==="cn"))){let s=e.getImportDeclaration(n=>n.getModuleSpecifierValue().includes("/lib/utils"));s?s.getNamedImports().some(i=>i.getName()==="cn")||s.addNamedImport("cn"):e.addImportDeclaration({moduleSpecifier:t.aliases.utils,namedImports:["cn"]});}}function wd(e){let t=[],r=[],n=e.slice(1,-1).split(/(\$\{[^}]+\})/);for(let i of n)if(i)if(i.startsWith("${")&&i.endsWith("}")){let o=i.slice(2,-1).trim();o&&r.push(o);}else {let o=i.trim().split(/\s+/).filter(Boolean);for(let c of o)t.push(`"${c}"`);}return [...t,...r]}function xd(e,t){let r=e;for(let s of t)r=r.replace(new RegExp(`,?\\s*${s.replace(".","\\.")}`,"g"),"").replace(/cn\(\s*,/,"cn(");return r}function vd(e){let t=e;for(let r of ["font-sans","font-serif","font-mono"])t=t.replace(new RegExp(`,?\\s*"${r}"`,"g"),"").replace(/cn\(\s*,/,"cn(");return t}function bd(e,t){let r=t.join(", ");return e.replace(/\)$/,`, ${r})`)}async function ca(e,t,r){r={overwrite:false,silent:false,interactive:true,isNewProject:false,...r};let s=await kn(t);return s&&s.ui&&s.ui.resolvedPaths.cwd!==t.resolvedPaths.cwd?await Id(e,t,s,{...r,isRemote:e?.length===1&&!!e[0].match(/\/chat\/b\//)}):await Sd(e,t,{...r,skipFonts:r.skipFonts})}async function Sd(e,t,r){if(!e.length)return;let s=await la(e,t,r),n=await Ne(t);r.skipFonts||(s=await Ys(s,t));let i=Hs([s]);await Bs(s.dependencies,s.devDependencies,t,{silent:r.silent,interactive:r.interactive}),await _r(s.tailwind?.config,t,{silent:r.silent,tailwindVersion:n}),await Js(s.envVars,t,{silent:r.silent}),r.skipFonts||await Zs(s.fonts,t,{silent:r.silent}),await kr(s.files,t,{overwrite:r.overwrite,silent:r.silent,interactive:r.interactive,path:r.path,supportedFontMarkers:i});let o=await ua(s,e,t,r.overwriteCssVars);await Gs(s.css,t,{silent:r.silent,cssVars:s.cssVars,cleanupDefaultNextStyles:r.isNewProject,overwriteCssVars:o,tailwindVersion:n,tailwindConfig:s.tailwind?.config}),s.docs&&I.info(s.docs);}async function Id(e,t,r,s){if(!e.length)return;let n=await la(e,t,s),i=[],o=[],c=[],a=j("Installing components.")?.start(),f=r.ui,l=await Ne(f),u=Lt(t.resolvedPaths.cwd,f.resolvedPaths.ui);n=await Ys(n,t);let d=Hs([n]);await Bs(n.dependencies,n.devDependencies,f,{silent:true,interactive:s.interactive}),n.tailwind?.config&&(await _r(n.tailwind?.config,f,{silent:true,tailwindVersion:l}),o.push(S__default.relative(u,f.resolvedPaths.tailwindConfig))),n.envVars&&await Js(n.envVars,f,{silent:true}),await Zs(n.fonts,t,{silent:true});let p=new Map,h={"registry:ui":"ui","registry:hook":"hooks","registry:lib":"lib"},m=R=>Gt(R.target)??h[R.type||"registry:ui"]??"components",g=R=>R&&r[R]?r[R]:t;for(let R of n.files??[]){let E=m(R);p.has(E)||p.set(E,[]),p.get(E).push(R);}for(let R of Array.from(p.keys())){let E=p.get(R),k=g(R),P=(n.files??[]).filter(Te=>g(m(Te)).resolvedPaths.cwd===k.resolvedPaths.cwd),D=Lt(t.resolvedPaths.cwd,k.resolvedPaths.ui||k.resolvedPaths.cwd),X=await Rr(D,k.resolvedPaths.cwd)??k.resolvedPaths.cwd,hr=await kr(E,k,{overwrite:s.overwrite,silent:true,interactive:s.interactive,rootSpinner:a,isRemote:s.isRemote,isWorkspace:true,path:s.path,plannedFiles:P,supportedFontMarkers:d});i.push(...hr.filesCreated.map(Te=>S__default.relative(D,S__default.join(X,Te)))),o.push(...hr.filesUpdated.map(Te=>S__default.relative(D,S__default.join(X,Te)))),c.push(...hr.filesSkipped.map(Te=>S__default.relative(D,S__default.join(X,Te))));}let x=await ua(n,e,t,s.overwriteCssVars);await Gs(n.css,f,{silent:true,cssVars:n.cssVars,overwriteCssVars:x,tailwindVersion:l,tailwindConfig:n.tailwind?.config}),(n.cssVars||n.css)&&o.push(S__default.relative(u,f.resolvedPaths.tailwindCss)),a?.succeed();let y=Array.from(new Set(i)).sort(),w=Array.from(new Set(o.filter(R=>!i.includes(R)))).sort(),v=Array.from(new Set(c)).sort();if(!(y.length||w.length)&&!v.length&&j("No files updated.",{silent:s.silent})?.info(),y.length){j(`Created ${y.length} ${y.length===1?"file":"files"}:`,{silent:s.silent})?.succeed();for(let R of y)I.log(`  - ${R}`);}if(w.length){j(`Updated ${w.length} ${w.length===1?"file":"files"}:`,{silent:s.silent})?.info();for(let R of w)I.log(`  - ${R}`);}if(v.length){j(`Skipped ${v.length} ${v.length===1?"file":"files"}: (use --overwrite to overwrite)`,{silent:s.silent})?.info();for(let R of v)I.log(`  - ${R}`);}n.docs&&I.info(n.docs);}async function la(e,t,r){let s=j("Checking registry.",{silent:r.silent})?.start(),n=r.resolvedTree??await Ye(e,ne(t));if(!n)throw s?.fail(),new Error("Failed to fetch components from registry.");try{Cd(n.files??[],t.resolvedPaths.cwd);}catch(i){throw s?.fail(),i}return s?.succeed(),n}async function ua(e,t,r,s){if(!(!e.cssVars||Object.keys(e.cssVars).length===0))return s??Ed(t,r)}async function Ed(e,t){let r=await Us(e,{config:t});return z.array(n).parse(r).some(n=>n.type==="registry:theme"||n.type==="registry:style"||n.type==="registry:font"||n.type==="registry:base")}function Cd(e,t){for(let r of e){let s=r?.target??r?.path;if(s&&!Qo(s,t))throw new Error(`We found an unsafe file path "${s}" in the registry item. Installation aborted.`)}}async function fa(e=process.cwd(),t={}){let r=t.processEnv??process.env;try{let{config:s}=await import('@dotenvx/dotenvx'),n=[".env.local",".env.development.local",".env.development",".env"];for(let i of n){let o=join(e,i);existsSync(o)&&s({path:o,overload:!1,quiet:!0,processEnv:r});}}catch(s){I.warn("Failed to load env files:",s);}return r}async function $d(e,t={}){if(e.length===0)return;let{config:r,cwd:s,...n}=t,i=d$1.safeParse(r);if(!i.success&&r&&"resolvedPaths"in r){let l=typeof r.resolvedPaths?.cwd=="string"?r.resolvedPaths.cwd:void 0;throw new We(S__default.resolve(s??l??process.cwd()),i.error,"config")}let o=i.success?i.data.resolvedPaths.cwd:void 0,c=S__default.resolve(s??o??process.cwd());if(s!==void 0&&o!==void 0&&c!==S__default.resolve(o))throw new Error("The provided cwd must match config.resolvedPaths.cwd.");let a=ne(i.success?i.data:{...r,resolvedPaths:{...r?.resolvedPaths,cwd:c}}),f=await fa(c,{processEnv:{...process.env}});return ve(async()=>{let l=await Ye(e,a,{useCache:true,requireUniversal:!i.success});if(!l)throw new Error("Failed to fetch components from registry.");if(!i.success&&!Td(l,a))throw new Error("A full project config is required to resolve target aliases.");await ca(e,a,{...n,interactive:false,overwriteCssVars:t.overwriteCssVars??(i.success?void 0:false),resolvedTree:l});},{env:f})}function Td(e,t){return (e.files??[]).every(r=>{let s=Gt(r.target);return !s||!!t.resolvedPaths[s]})}function _R(e,t){return e.length>0?e:Object.keys(t?.registries??{}).filter(r=>!(r in H))}var jd=8;async function Od(e,t,r){let s=new Array(e.length),n=0;async function i(){for(;n<e.length;){let c=n++;try{s[c]={status:"fulfilled",value:await r(e[c])};}catch(a){s[c]={status:"rejected",reason:a};}}}let o=Array.from({length:Math.min(t,e.length)},()=>i());return await Promise.all(o),s}async function Nd(e,t){return ve(()=>_d(e,t))}async function _d(e,t){let{query:r,types:s,limit:n,offset:i,config:o,useCache:c=false,continueOnError:a}=t||{},f=[],l=e.length===1,u=s?.map(E=>Wd(E)),d=l?{query:r,types:u,limit:n,offset:i}:{query:r,types:u,limit:n!==void 0?(i||0)+n:void 0,offset:void 0},p=await Od(e,jd,E=>zs(E,{config:o,useCache:c,searchParams:d})),h=[],m=[];for(let E=0;E<e.length;E++){let k=e[E],P=p[E];if(P.status==="rejected"){if(!a)throw P.reason;f.push({registry:k,message:P.reason instanceof Error?P.reason.message:String(P.reason)});continue}let D=(P.value.items||[]).map(X=>({name:X.name,title:X.title,type:X.type,description:X.description,registry:k,addCommandArgument:Ld(X.name,k)}));if(P.value.pagination){m.push({items:D,pagination:P.value.pagination});continue}h=h.concat(D);}if(l&&m.length===1){let[E]=m;return y.parse({pagination:E.pagination,items:E.items})}if(s?.length){let E=new Set(s.map(k=>et(k).toLowerCase()));h=h.filter(k=>k.type&&E.has(et(k.type).toLowerCase()));}r&&(h=Md(h,{query:r,limit:h.length,keys:["name","title","description"]}));let g=m.flatMap(E=>E.items).concat(h),x=m.reduce((E,k)=>E+k.pagination.total,0),y$1=i||0,w=n||g.length,v=x+h.length,b=m.some(E=>E.pagination.hasMore&&d.limit!==void 0&&E.items.length>=d.limit),R={pagination:{total:v,offset:y$1,limit:w,hasMore:y$1+w<g.length||b},items:g.slice(y$1,y$1+w),...f.length>0?{errors:f}:{}};return y.parse(R)}var Fd=z.object({name:z.string(),title:z.string().optional(),type:z.string().optional(),description:z.string().optional(),registry:z.string().optional(),addCommandArgument:z.string().optional()}).passthrough();function Md(e,t){t={limit:100,threshold:-1e4,...t};let s=Ad.go(t.query,e,{keys:t.keys,threshold:t.threshold,limit:t.limit}).map(n=>n.obj);return z.array(Fd).parse(s)}function Dd(e){try{return new URL(e),!0}catch{return  false}}function Ld(e,t){let r=pt(t);if(r){let p=`${r.owner}/${r.repo}/${e}`;return r.ref?`${p}#${r.ref}`:p}if(!Dd(t))return `${t}/${e}`;let s=t.indexOf("://")+3,n=t.indexOf("/",s);if(n===-1){let p=t.indexOf("?",s);if(p!==-1){let h=t.substring(0,p),g=t.substring(p).replace(/\bregistry\b/g,e);return h+g}return t}let i=t.substring(0,n),o=t.substring(n),c=o.indexOf("?")!==-1?o.indexOf("?"):o.length,a=o.substring(0,c),f=o.substring(c),l=a.lastIndexOf("registry"),u=a;l!==-1&&(u=a.substring(0,l)+e+a.substring(l+8));let d=f.replace(/\bregistry\b/g,e);return i+u+d}var Vd=80;function et(e){return e?e.startsWith("registry:")?e.slice(9):e:""}function Wd(e){return e.startsWith("registry:")?e:`registry:${e}`}var zd=["registry:example","registry:internal"],Ud=f.options.filter(e=>!zd.includes(e)).map(e=>et(e));function FR(e){let t=new Set(Ud.map(r=>r.toLowerCase()));return e.filter(r=>!t.has(et(r).toLowerCase()))}function Hd(e,t=Vd){let r=e.trim().replace(/\s+/g," ");if(r.length<=t)return r;let s=r.slice(0,t-3).trimEnd(),n=s.lastIndexOf(" ");return `${(n>t*.6?s.slice(0,n):s).trimEnd()}...`}function Kd(e,t){let r=e.addCommandArgument??e.name,s=et(e.type),n=s?` (${s})`:"",i=t.showRegistry&&e.registry?` \xB7 ${e.registry}`:"",o=e.description?` \u2014 ${Hd(e.description)}`:"";return `- ${T.info(r)}${n}${i}${o}`}function pa(e){let{query:t,types:r,registries:s}=e,n="";return r?.length&&(n+=` of type ${r.map(i=>et(i)).join(", ")}`),t&&(n+=` matching ${T.info(`"${t}"`)}`),s.length>0&&(n+=` in ${s.join(", ")}`),n}function MR(e,t){let{pagination:r,items:s,errors:n}=e,i=t.registries.length>1;if(n?.length){for(let{registry:f,message:l}of n)I.warn(`Skipped ${f}: ${l}`);I.break();}if(s.length===0){I.warn(`No items found${pa(t)}.`);return}let o=`${r.total} item${r.total===1?"":"s"}`;I.info(`Found ${o}${pa(t)}`);let c=r.offset+1,a=Math.min(r.offset+r.limit,r.total);I.log(`Showing ${c}-${a} of ${r.total}`),I.break(),I.log(s.map(f=>Kd(f,{showRegistry:i})).join(`
`)),r.hasMore&&(I.break(),I.log(`More items available. Use ${T.info(`--offset ${r.offset+r.limit}`)} to see the next page.`));}var Qs=32;async function Gd(e){let{cwd:t,registryFile:r}=ba(e),s=await ha(r,{cwd:t}),n=Ra(s,t,r);return qd(s,n,t)}async function Bd(e,t){let{cwd:r,registryFile:s}=ba(t),n=await ha(s,{cwd:r}),i=n.registry.items.find(c=>c.name===e);if(!i)throw new Oe(e);let o=Ra(n,r,s);return Jd(i,n,o,r)}async function ha(e,t){let r=S.resolve(t.cwd,e),s=await wa(r),n=xa(s,r);da(n,r);let i={cwd:S.resolve(t.cwd),itemSources:new Map,itemSourcesByItem:new Map,firstIncludedFrom:new Map},o=!!n.include?.length;if(!o)return n.items.forEach((l,u)=>{let d={registryFile:r,registryDir:i.cwd,itemIndex:u};i.itemSources.set(l.name,d),i.itemSourcesByItem.set(l,d);}),{registry:n,itemSources:i.itemSources,itemSourcesByItem:i.itemSourcesByItem,usesInclude:o};if(S.basename(r)!=="registry.json")throw new $(`Invalid registry file at ${r}: registries that use include must be named registry.json.`,{registryFile:r});let c=await ya(r,n,i,[]);th(c.items,i.itemSourcesByItem);let{include:a,...f}=c;return da(f,r),{registry:f,itemSources:i.itemSources,itemSourcesByItem:i.itemSourcesByItem,usesInclude:o}}function qd(e,t,r){return {...e.registry,items:e.registry.items.map(s=>Zd(ma(s,e.itemSourcesByItem,t,r)))}}async function Jd(e,t,r,s){let n$1={...ma(e,t.itemSourcesByItem,r,s),$schema:"https://ui.shadcn.com/schema/registry-item.json"};return await Promise.all((e.files??[]).map(async(i,o)=>{let c=n$1.files?.[o];if(!c)return;let a=t.itemSourcesByItem.get(e),f=ga(e,i.path,t.itemSourcesByItem,s);c.content=await Yd(e.name,i.path,f,a);})),n.parse(n$1)}async function Yd(e,t,r,s){try{return await Vi.readFile(r,"utf-8")}catch(n){throw new ae(r,n,{message:`Failed to read file "${t}" for registry item "${e}" (${Rt(s)}). Expected file at ${r}.`,context:{itemName:e,itemFilePath:t,sourcePath:r},suggestion:"Make sure the file path is relative to the registry.json file that declares the item."})}}function ma(e,t,r,s){return {...e,files:e.files?.map(n=>({...n,path:Xd(e,n.path,t,r,s)}))}}function Zd(e){return {...e,files:e.files?.map(({content:t,...r})=>r)}}function ga(e,t,r,s){let n=r.get(e);return S.resolve(n?.registryDir??s,t)}function Xd(e,t,r,s,n){let i=ga(e,t,r,n);return S.relative(s,i).split(S.sep).join("/")}async function ya(e,t,r,s){if(va(e,r.cwd),s.length>=Qs)throw new $(`Registry include tree is too deep at ${e}. The maximum include depth is ${Qs}.`,{registryFile:e,context:{maxDepth:Qs},suggestion:"Flatten part of the registry include tree or reduce nested include depth."});if(s.includes(e))throw new $(rh([...s,e]),{registryFile:e});let n=s.at(-1)??e,i=r.firstIncludedFrom.get(e);if(i)throw new $(`Registry file included more than once: ${e}.
  - first included from ${i}
  - included again from ${n}
Each registry.json file can only appear once in the resolved include tree. Remove one include or move shared items into a single included registry.json.`,{registryFile:e,context:{firstSource:i,secondSource:n}});r.firstIncludedFrom.set(e,n);let o=[...s,e],c=S.dirname(e),a=[];for(let f of t.include??[]){let l=Qd(f,c,r.cwd,e),u=await wa(l),d=xa(u,l),p=await ya(l,d,r,o);a.push(...p.items);}return t.items.forEach((f,l)=>{eh(f,e,c),r.itemSources.set(f.name,{registryFile:e,registryDir:c,itemIndex:l}),r.itemSourcesByItem.set(f,{registryFile:e,registryDir:c,itemIndex:l});}),{...t,items:[...a,...t.items]}}async function wa(e){try{return await Vi.readFile(e,"utf-8")}catch(t){throw new ae(e,t,{message:`Failed to read registry file at ${e}.`,context:{registryFile:e},suggestion:"Check that the registry.json file exists and that the path is correct."})}}function xa(e,t){let r;try{r=JSON.parse(e);}catch(n){throw new W(t,n,{subject:"registry file",context:{registryFile:t},suggestion:"Fix the JSON syntax in the registry.json file and try again."})}let s=p.safeParse(r);if(!s.success)throw new $(`Invalid registry file at ${t}:
${sh(s.error)}`,{registryFile:t,cause:s.error,suggestion:"Update the registry.json file so it matches the registry schema."});return s.data}function da(e,t){let r=[];if(e.name||r.push("name"),e.homepage||r.push("homepage"),r.length)throw new $(`Invalid root registry file at ${t}: root registry.json must define ${r.map(s=>`"${s}"`).join(" and ")}. Included registry.json files may omit these fields.`,{registryFile:t})}function Qd(e,t,r,s){if(M(e))throw new $(`Invalid include "${e}" in ${s}: remote includes are not supported by shadcn build. Use a relative path to a registry.json file in the same repository.`,{registryFile:s,context:{includePath:e}});if(S.isAbsolute(e))throw new $(`Invalid include "${e}" in ${s}: include paths must be relative. Use a path like "./registry/ui/registry.json".`,{registryFile:s,context:{includePath:e}});if(Sa(e))throw new $(`Invalid include "${e}" in ${s}: include paths cannot use parent-directory traversal. Keep included registry.json files inside the registry root.`,{registryFile:s,context:{includePath:e}});if(S.basename(e)!=="registry.json")throw new $(`Invalid include "${e}" in ${s}: include paths must explicitly reference a registry.json file. Use a path like "./registry/ui/registry.json".`,{registryFile:s,context:{includePath:e}});let n=S.resolve(t,e);return va(n,r),n}function va(e,t){if(!Ia(e,t))throw new $(`Invalid registry file at ${e}: registry includes must stay inside ${t}.`,{registryFile:e,context:{cwd:t}})}function ba(e){return {cwd:S.resolve(e?.cwd??process.cwd()),registryFile:e?.registryFile??"registry.json"}}function Ra(e,t,r){return e.usesInclude?S.dirname(S.resolve(t,r)):t}function eh(e,t,r){for(let s of e.files??[]){if(M(s.path))throw new $(`Invalid file path "${s.path}" for item "${e.name}" in ${t}: remote file paths are not supported by shadcn build.`,{registryFile:t,context:{itemName:e.name,filePath:s.path}});if(S.isAbsolute(s.path))throw new $(`Invalid file path "${s.path}" for item "${e.name}" in ${t}: file paths must be relative.`,{registryFile:t,context:{itemName:e.name,filePath:s.path}});if(Sa(s.path))throw new $(`Invalid file path "${s.path}" for item "${e.name}" in ${t}: file paths cannot use parent-directory traversal.`,{registryFile:t,context:{itemName:e.name,filePath:s.path}});let n=S.resolve(r,s.path);if(!Ia(n,r))throw new $(`Invalid file path "${s.path}" for item "${e.name}" in ${t}: file paths must stay inside the registry chunk directory.`,{registryFile:t,context:{itemName:e.name,filePath:s.path}})}}function th(e,t){let r=new Map;for(let s of e){let n=r.get(s.name);if(!n){r.set(s.name,s);continue}let i=t.get(n),o=t.get(s);throw new $(`Duplicate registry item name "${s.name}". Registry item names must be unique.
  - ${Rt(i)}
  - ${Rt(o)}
Rename one of these items so each name is unique across the resolved registry.`,{context:{itemName:s.name,firstSource:Rt(i),secondSource:Rt(o)}})}}function Sa(e){return e.split(/[\\/]+/).includes("..")}function Ia(e,t){let r=S.relative(t,e);return !!r&&!r.startsWith("..")&&!S.isAbsolute(r)}function rh(e){return `Registry include cycle detected:
${e.map(t=>`  - ${t}`).join(`
`)}`}function Rt(e){return e?`${e.registryFile} items[${e.itemIndex}]`:"unknown source"}function sh(e){return e.errors.map(t=>`  - ${t.path.length?t.path.join("."):"(root)"}: ${t.message}`).join(`
`)}export{ne as $,jn as A,Sm as Aa,_e as B,Ne as Ba,j as C,Im as Ca,Bt as D,Hs as Da,Jt as E,ab as Ea,Zt as F,Ks as Fa,Xt as G,Gs as Ga,Ln as H,zp as Ha,Vn as I,Bs as Ia,Qt as J,Ys as Ja,er as K,Zs as Ka,qc as L,ca as La,Bn as M,fa as Ma,M as N,Gd as Na,Jn as O,Bd as Oa,pt as P,ha as Pa,ri as Q,qd as Qa,nm as R,Jd as Ra,im as S,$d as Sa,om as T,_R as Ta,am as U,Nd as Ua,Mt as V,Ud as Va,ut as W,FR as Wa,Dt as X,MR as Xa,kn as Y,cm as Z,$n as _,V as a,Py as aa,H as b,Ge as ba,ih as c,fw as ca,oh as d,be as da,T as e,Ye as ea,I as f,Ds as fa,jh as g,hv as ga,Oh as h,Ho as ha,Nh as i,ur as ia,Da as j,zs as ja,L as k,Us as ka,_ as l,Rp as la,je as m,Sp as ma,tt as n,Vt as na,rt as o,Hv as oa,st as p,Kv as pa,de as q,Gv as qa,ae as r,tr as ra,W as s,Ip as sa,$ as t,Bv as ta,Oe as u,qv as ua,nt as v,Zo as va,it as w,Ep as wa,ot as x,Cp as xa,he as y,Jv as ya,J as z,Y as za};