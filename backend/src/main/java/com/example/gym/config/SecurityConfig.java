    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/users/**").hasAnyRole("SUDO", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/dashboard").hasAnyRole("SUDO", "ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/api/movements").hasAnyRole("SUDO", "ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/movements/product-sale")
                        .hasAnyRole("SUDO", "ADMIN", "USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/movements/**").hasAnyRole("SUDO", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/inventory/**").hasAnyRole("SUDO", "ADMIN", "USER")
                        ...
                        .hasAnyRole("SUDO", "ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/api/clients/**").hasAnyRole("SUDO", "ADMIN", "USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/membership-plans/**").hasAnyRole("SUDO", "ADMIN", "USER")
                        .requestMatchers(HttpMethod.GET, "/api/membership-qr/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/memberships/validate")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/products/**").hasAnyRole("SUDO", "ADMIN", "USER")
                        ...
                        .requestMatchers("/api/**").hasAnyRole("SUDO", "ADMIN", "USER")
